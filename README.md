...
| Name | Summary |
| --- | --- |
| [common-sense](plugins/common-sense/README.md) | Shared judgment for humans and agents. Its first skill inspects the diff, routes context to the right destination, and keeps commit messages focused on why the change exists in its current form. |
